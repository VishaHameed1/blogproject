<x-guest-layout>
    <style>
        ...
        [data-theme="dark"] .password-confirm-input:focus {
            ...
            <div class="neon-tracer-box shadow-2xl shadow-[var(--color-primary)]/15">
                <div class="card-bg border border-[var(--color-border)] rounded-[22px] p-8 sm:p-10">
                    ...
                    <div class="text-center mb-8">
                        ...
                        <div class="mt-3 text-sm text-[var(--color-text-muted)] leading-relaxed secure-message p-4 rounded-xl border">
                    ...
                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                class="w-full px-4 py-3 rounded-xl password-confirm-input text-[var(--color-text-primary)] placeholder:text-[var(--color-text-muted)] border border-[var(--color-border)] focus:border-[var(--color-primary)] focus:ring-1 focus:ring-[var(--color-primary)]/30 transition-all duration-300 text-base"
                            />
                        ...
                        <div class="flex justify-end mt-4">
                            <button 
                                type="submit"
                                class="px-6 py-3 btn-primary text-white font-medium rounded-xl transition-all duration-300 shadow-lg shadow-[var(--color-primary)]/20 hover:shadow-[var(--color-primary)]/40 transform hover:scale-[1.02] text-base heading-font min-w-[120px]"
                            >
                                {{ __('Confirm') }}
                            </button>
                        </div>
