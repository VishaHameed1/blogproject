...
<div class="max-w-4xl mx-auto animate-fade-in">
    ...
    <div class="mb-8 text-center sm:text-left">
        <h1 class="heading-font text-3xl font-bold text-white tracking-tight">New Category</h1>
        <p class="text-sm text-white/50 mt-1">Create a new blog category</p>
    </div>

    {{-- Form --}}
    <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data" class="bg-[#121212] border border-white/5 rounded-2xl shadow-xl p-6 md:p-8 space-y-6 transition-all duration-300 hover:border-rust/30">
        @csrf
        ...
        <div>
            ...
            <div class="px-4 py-3 rounded-xl bg-[#0a0a0a]/80 border border-white/5 text-white/30 font-mono text-sm" id="slug-display">
                auto-generated
            </div>
        ...
        {{-- Image Upload --}}
        <div>
            <label class="block text-sm heading-font font-semibold text-white/60 mb-2">Category Image</label>
            <div>
                <input type="file" 
                       name="image" 
                       id="image" 
            ...
            <div id="image-preview" class="hidden mt-3">
                <p class="text-xs heading-font font-semibold text-white/30 mb-2">Image Preview</p>
                <div class="relative inline-block">
                    <img id="preview" src="" alt="Preview" class="h-32 w-auto rounded-xl border border-white/5 object-cover shadow-md">
                </div>
            </div>
        </div>
