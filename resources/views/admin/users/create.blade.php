...
<div class="max-w-3xl mx-auto space-y-6 animate-fade-in">
    ...
    <div class="text-center sm:text-left">
        <h1 class="heading-font text-3xl font-bold text-white tracking-tight">New User</h1>
        <p class="text-sm text-white/50 mt-1">Create a new user account</p>
    </div>

    {{-- Form --}}
    <form method="POST" action="{{ route('admin.users.store') }}" class="bg-[#121212] border border-white/5 rounded-2xl shadow-xl p-6 md:p-8 space-y-6 transition-all duration-300 hover:border-rust/30">
        @csrf
        ...
        {{-- Password --}}
        <div class="group">
            <label for="password" class="block text-sm heading-font font-semibold text-white/60 mb-2 transition-colors group-focus-within:text-rust">Password <span class="text-rust">*</span></label>
            <input type="password" 
                   name="password" 
                   id="password" 
                   required
        ...
        {{-- Confirm Password --}}
        <div class="group">
            <label for="password_confirmation" class="block text-sm heading-font font-semibold text-white/60 mb-2 transition-colors group-focus-within:text-rust">Confirm Password <span class="text-rust">*</span></label>
            <input type="password" 
