...
<div class="max-w-2xl mx-auto">
    ...
    <div class="text-center mb-8">
        <h1 class="heading-font text-2xl sm:text-3xl font-bold text-white tracking-tight">Edit User</h1>
        <p class="text-sm text-white/40 mt-1">Update user details and role</p>
    </div>

    {{-- Form --}}
    <form method="POST" action="{{ route('admin.users.update', $user) }}" class="bg-[#121212] border border-white/5 rounded-2xl shadow-xl p-6 md:p-8 hover:border-rust/30 transition-all duration-300">
        @csrf
        @method('PUT')
        ...
        {{-- Password --}}
        <div class="mb-6">
            <label for="password" class="block text-sm font-medium text-white/60 mb-1.5 heading-font">Password</label>
            <input type="password" 
                   name="password" 
                   id="password" 
                   class="w-full px-4 py-2.5 rounded-xl bg-[#0a0a0a]/80 border border-white/5 text-white placeholder:text-white/20 focus:outline-none focus:border-rust focus:ring-1 focus:ring-rust/30 transition-all text-sm"
        ...
        {{-- Confirm Password --}}
        <div class="mb-6">
            <label for="password_confirmation" class="block text-sm font-medium text-white/60 mb-1.5 heading-font">Confirm Password</label>
            <input type="password" 
